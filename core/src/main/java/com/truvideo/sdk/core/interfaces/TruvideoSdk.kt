...
import com.truvideo.sdk.core.usecases.TruvideoSdkFilePickerRequester
import com.truvideo.sdk.core.usecases.TruvideoSdkPermissionRequester
...
interface TruvideoSdk {
    ...
    fun initPermissionRequester(activity: ComponentActivity): TruvideoSdkPermissionRequester

    fun initFilePickerRequester(activity: ComponentActivity): TruvideoSdkFilePickerRequester
